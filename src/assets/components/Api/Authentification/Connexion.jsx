...
const Login = (result) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { token } = response.data; // le token JWT est renvoyé par le backend
      console.log({ token });

      // Stockez le token JWT de manière sécurisée (par exemple, dans les cookies ou localStorage)
      // Redirigez l'utilisateur vers une page protégée ou effectuez d'autres actions selon vos besoins.
    } catch (error) {
      console.log('erreur')
